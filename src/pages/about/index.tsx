        ...
        <div className={styles.pageContainer}>
            <div className={styles.infoContainer}>
                <Info
                    ...
                    text={`We provide various interrelated experiences that inculcate
                     academics with adventure. We are working towards revamping undergraduate 
                     education in the nation, with the vision to adorn the system with experiential learning. 
                     We are new-age education providers to help people understand the fast-paced world by slowing them 
                     down and allowing them to experience learning amalgamated with fun.`}
                />
